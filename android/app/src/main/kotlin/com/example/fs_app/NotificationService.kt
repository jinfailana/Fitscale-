...
class NotificationService : Service() {
    ...
    private fun showNotification() {
        ...
        val notification = NotificationCompat.Builder(this, CHANNEL_ID)
            .setContentTitle("Return to FitScale")
            .setContentText("Tap to return to your workout routine and stays on track with your goals.")
            .setStyle(NotificationCompat.BigTextStyle()
                .bigText("It's to continue your fitness journey!"))
