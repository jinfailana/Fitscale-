...
class _SetWeightManuallyPageState extends State<SetWeightManuallyPage> {
  ...
  final List<double> weightsKg = List.generate(221, (index) => (30 + index).toDouble());
  final List<double> weightsLbs = List.generate(485, (index) => (66 + index).toDouble());
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ListView.builder(
                    itemCount: unit == 'kg' ? weightsKg.length : weightsLbs.length,
                    itemBuilder: (context, index) {
                      double weight = unit == 'kg' ? weightsKg[index] : weightsLbs[index];
